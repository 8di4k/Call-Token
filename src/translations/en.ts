const en = {
    ...
    about: {
        hero: {
          title: 'About $PRIKOL',
          subtitle: 'Discover the story behind the most innovative meme token in the crypto space'
        },
        heroButtons: {
          launch: 'Launch on Pump.fun',
          website: 'Visit Website'
        },
        mission: {
          title: 'Our Mission',
          text1: '$PRIKOL aims to revolutionize the meme token space by combining humor with real utility. We believe that cryptocurrency should be fun, accessible, and valuable for everyone.',
          text2: 'Our community-driven approach ensures that every holder has a voice in the project’s direction, making $PRIKOL truly decentralized and democratic.'
        },
        values: {
          security: {
            title: 'Security',
            text: 'Fully audited and secure smart contract'
          },
          transparency: {
            title: 'Transparency',
          ...
          community: {
            title: 'Community',
            text: 'Strong and engaged community'
          },
          innovation: {
            title: 'Innovation',
            text: 'Continuous development and improvement'
          }
        },
        join: {
          title: 'Join Our Community',
          subtitle: 'Be part of the $PRIKOL revolution and help shape the future of meme tokens',
          telegram: {
            title: 'Telegram Community',
            text: 'Join our active Telegram group'
          },
          twitter: {
            title: 'Twitter',
            text: 'Follow us for latest updates'
          }
        }
    }
  };
